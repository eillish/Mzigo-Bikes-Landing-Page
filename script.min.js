!function(e){"use strict";var i=function(){
    // Swiper instance for .main-swiper - NAVIGATION REMOVED
    new Swiper(".main-swiper",{
        slidesPerView:3,
        spaceBetween:80,
        speed:700,
        loop:!0,
        // navigation:{nextEl:".icon-arrow-right",prevEl:".icon-arrow-left"}, // Removed this line
        breakpoints:{300:{slidesPerView:1,spaceBetween:20},768:{slidesPerView:2,spaceBetween:20},1200:{slidesPerView:3,spaceBetween:80}}
    }),
    // Swiper instance for .slideshow - NAVIGATION REMOVED
